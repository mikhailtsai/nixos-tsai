...

{
  environment.systemPackages = with pkgs; [
    ...
    # -------------------------------------------------------------------------
    # Удалённый доступ (RDP / VNC / SPICE)
    # -------------------------------------------------------------------------
    remmina         # GUI-клиент: вкладки, профили подключений, общий буфер
    freerdp         # xfreerdp / wlfreerdp — CLI-клиент RDP (и бэкенд RDP-плагина remmina)
