...

{
  ...
  xdg.configFile."hypr/hyprland.conf".text = ''
    ...
    windowrule = immediate on, match:class ^(wow.exe|Wow.exe|WowClassic.exe|Battle.net.exe)$
    windowrule = no_blur on, match:class ^(wow.exe|Wow.exe|WowClassic.exe|Battle.net.exe)$
